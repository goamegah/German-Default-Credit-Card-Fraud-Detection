...
class Analyser:
    ...
    def summary(self, df_c: pd.DataFrame) -> dict:
        ...
        # Return a dictionary containing the qualitative and quantitative columns, as well as a description of the
        # DataFrame
        return {"features":
            {
    ...
    def prop_churn_by_cats(self, df_c: pd.DataFrame, outcome: str, cats_name: str, loc="upper right") -> None:
        # Define a method to create a stacked barchart of the proportions of churn vs. non churn for a specified
